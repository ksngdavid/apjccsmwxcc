...
//Set emergency Handlebar routes
app.get('/deescalate.html', (req, res) => {
    const deactivateToggle = require('request').defaults({
        headers: {
        "Content-Type": "application/json",
        },
        body: {
    ...
    deactivateToggle.post('https://hooks.au.webexconnect.io/events/WN9D601TKT', {json: true}, (err, res, body) => {
            if (err) {return console.log(err);}
    });
    ...
    get_wxcctoken(function(gotToken) {
        ...
        get_toggle(function(gotToggle) {
            ...
            if (gotToggle.defaultValue === 'true') {
                res.render('distiescalateTruerefresh', {
                    stuff: "This is stuff...",               // to pass variable from backend to frontend (html)
                    gcfToken: gotToken,
                    toggleGV: gotToggle
                });
